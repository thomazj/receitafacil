package com.example.receitafacil.presentation.features.register.di

import com.example.receitafacil.core.data.remote.RecipesServiceApi
import com.example.receitafacil.presentation.features.register.data.repository.RegisterUserRepositoryImpl
import com.example.receitafacil.presentation.features.register.data.source.RegisterUserRemoteDataSourceImpl
...
import com.example.receitafacil.presentation.features.register.domain.usecase.ValidateRegisterInputUseCase
import com.example.receitafacil.presentation.features.register.domain.usecase.ValidateRegisterInputUseCaseImpl
